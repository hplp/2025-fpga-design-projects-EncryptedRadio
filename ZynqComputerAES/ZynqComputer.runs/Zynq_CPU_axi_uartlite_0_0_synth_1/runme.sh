...
HD_PWD='C:/Users/kuh4bd/Documents/FPGALab/Project_UART/ZynqComputerAES/ZynqComputer.runs/Zynq_CPU_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_CPU_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_CPU_axi_uartlite_0_0.tcl
