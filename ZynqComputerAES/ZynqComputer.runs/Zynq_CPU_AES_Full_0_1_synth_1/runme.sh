...
HD_PWD='C:/Users/kuh4bd/Documents/FPGALab/Project_UART/ZynqComputerAES/ZynqComputer.runs/Zynq_CPU_AES_Full_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_CPU_AES_Full_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_CPU_AES_Full_0_1.tcl
