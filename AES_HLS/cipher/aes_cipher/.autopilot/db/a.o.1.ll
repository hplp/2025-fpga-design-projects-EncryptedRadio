; ModuleID = 'D:/OneDrive/UVA/crypto/AES_code/VivadoHLS/cipher/aes_cipher/.autopilot/db/a.g.1.bc'
...
; [#uses=1]
define internal fastcc void @SubBytes(i8* %state) nounwind uwtable noinline {
  call void @llvm.dbg.value(metadata !{i8* %state}, i64 0, metadata !2725), !dbg !2726 ; [debug line = 4:30] [debug variable = state]
  call void (...)* @_ssdm_InlineSelf(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2727 ; [debug line = 5:1]
  br label %1, !dbg !2729                         ; [debug line = 6:27]

; <label>:1                                       ; preds = %2, %0
  %i = phi i16 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i16]
  %tmp = icmp eq i16 %i, 16, !dbg !2729           ; [#uses=1 type=i1] [debug line = 6:27]
  br i1 %tmp, label %3, label %2, !dbg !2729      ; [debug line = 6:27]

; <label>:2                                       ; preds = %1
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2731 ; [#uses=1 type=i32] [debug line = 6:48]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2733 ; [debug line = 7:1]
  %tmp.1 = zext i16 %i to i64, !dbg !2734         ; [#uses=1 type=i64] [debug line = 8:2]
  %state.addr = getelementptr inbounds i8* %state, i64 %tmp.1, !dbg !2734 ; [#uses=2 type=i8*] [debug line = 8:2]
  %state.load = load i8* %state.addr, align 1, !dbg !2734 ; [#uses=2 type=i8] [debug line = 8:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load) nounwind
  %tmp.2 = zext i8 %state.load to i64, !dbg !2734 ; [#uses=1 type=i64] [debug line = 8:2]
  %s_box.addr = getelementptr inbounds [256 x i8]* @s_box, i64 0, i64 %tmp.2, !dbg !2734 ; [#uses=1 type=i8*] [debug line = 8:2]
  %s_box.load = load i8* %s_box.addr, align 1, !dbg !2734 ; [#uses=2 type=i8] [debug line = 8:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %s_box.load) nounwind
  store i8 %s_box.load, i8* %state.addr, align 1, !dbg !2734 ; [debug line = 8:2]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2735 ; [#uses=0 type=i32] [debug line = 9:2]
  %i.1 = add i16 %i, 1, !dbg !2736                ; [#uses=1 type=i16] [debug line = 6:42]
  call void @llvm.dbg.value(metadata !{i16 %i.1}, i64 0, metadata !2737), !dbg !2736 ; [debug line = 6:42] [debug variable = i]
  br label %1, !dbg !2736                         ; [debug line = 6:42]

; <label>:3                                       ; preds = %1
  ret void, !dbg !2738                            ; [debug line = 10:1]
}

; [#uses=1]
define internal fastcc void @ShiftRows(i8* %state) nounwind uwtable noinline {
  %tmp_state = alloca [16 x i8], align 16         ; [#uses=17 type=[16 x i8]*]
  call void @llvm.dbg.value(metadata !{i8* %state}, i64 0, metadata !2739), !dbg !2740 ; [debug line = 20:31] [debug variable = state]
  call void (...)* @_ssdm_InlineSelf(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2741 ; [debug line = 21:1]
  call void @llvm.dbg.declare(metadata !{[16 x i8]* %tmp_state}, metadata !2743), !dbg !2745 ; [debug line = 22:16] [debug variable = tmp_state]
  %state.load = load i8* %state, align 1, !dbg !2746 ; [#uses=2 type=i8] [debug line = 23:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load) nounwind
  %tmp_state.addr = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 0, !dbg !2746 ; [#uses=1 type=i8*] [debug line = 23:2]
  store i8 %state.load, i8* %tmp_state.addr, align 16, !dbg !2746 ; [debug line = 23:2]
  %state.addr = getelementptr inbounds i8* %state, i64 5, !dbg !2747 ; [#uses=1 type=i8*] [debug line = 24:2]
  %state.load.1 = load i8* %state.addr, align 1, !dbg !2747 ; [#uses=2 type=i8] [debug line = 24:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.1) nounwind
  %tmp_state.addr.1 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 1, !dbg !2747 ; [#uses=1 type=i8*] [debug line = 24:2]
  store i8 %state.load.1, i8* %tmp_state.addr.1, align 1, !dbg !2747 ; [debug line = 24:2]
  %state.addr.1 = getelementptr inbounds i8* %state, i64 10, !dbg !2748 ; [#uses=1 type=i8*] [debug line = 25:2]
  %state.load.2 = load i8* %state.addr.1, align 1, !dbg !2748 ; [#uses=2 type=i8] [debug line = 25:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.2) nounwind
  %tmp_state.addr.2 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 2, !dbg !2748 ; [#uses=1 type=i8*] [debug line = 25:2]
  store i8 %state.load.2, i8* %tmp_state.addr.2, align 2, !dbg !2748 ; [debug line = 25:2]
  %state.addr.2 = getelementptr inbounds i8* %state, i64 15, !dbg !2749 ; [#uses=1 type=i8*] [debug line = 26:2]
  %state.load.3 = load i8* %state.addr.2, align 1, !dbg !2749 ; [#uses=2 type=i8] [debug line = 26:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.3) nounwind
  %tmp_state.addr.3 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 3, !dbg !2749 ; [#uses=1 type=i8*] [debug line = 26:2]
  store i8 %state.load.3, i8* %tmp_state.addr.3, align 1, !dbg !2749 ; [debug line = 26:2]
  %state.addr.3 = getelementptr inbounds i8* %state, i64 4, !dbg !2750 ; [#uses=1 type=i8*] [debug line = 28:2]
  %state.load.4 = load i8* %state.addr.3, align 1, !dbg !2750 ; [#uses=2 type=i8] [debug line = 28:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.4) nounwind
  %tmp_state.addr.4 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 4, !dbg !2750 ; [#uses=1 type=i8*] [debug line = 28:2]
  store i8 %state.load.4, i8* %tmp_state.addr.4, align 4, !dbg !2750 ; [debug line = 28:2]
  %state.addr.4 = getelementptr inbounds i8* %state, i64 9, !dbg !2751 ; [#uses=1 type=i8*] [debug line = 29:2]
  %state.load.5 = load i8* %state.addr.4, align 1, !dbg !2751 ; [#uses=2 type=i8] [debug line = 29:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.5) nounwind
  %tmp_state.addr.5 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 5, !dbg !2751 ; [#uses=1 type=i8*] [debug line = 29:2]
  store i8 %state.load.5, i8* %tmp_state.addr.5, align 1, !dbg !2751 ; [debug line = 29:2]
  %state.addr.5 = getelementptr inbounds i8* %state, i64 14, !dbg !2752 ; [#uses=1 type=i8*] [debug line = 30:2]
  %state.load.6 = load i8* %state.addr.5, align 1, !dbg !2752 ; [#uses=2 type=i8] [debug line = 30:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.6) nounwind
  %tmp_state.addr.6 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 6, !dbg !2752 ; [#uses=1 type=i8*] [debug line = 30:2]
  store i8 %state.load.6, i8* %tmp_state.addr.6, align 2, !dbg !2752 ; [debug line = 30:2]
  %state.addr.6 = getelementptr inbounds i8* %state, i64 3, !dbg !2753 ; [#uses=1 type=i8*] [debug line = 31:2]
  %state.load.7 = load i8* %state.addr.6, align 1, !dbg !2753 ; [#uses=2 type=i8] [debug line = 31:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.7) nounwind
  %tmp_state.addr.7 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 7, !dbg !2753 ; [#uses=1 type=i8*] [debug line = 31:2]
  store i8 %state.load.7, i8* %tmp_state.addr.7, align 1, !dbg !2753 ; [debug line = 31:2]
  %state.addr.7 = getelementptr inbounds i8* %state, i64 8, !dbg !2754 ; [#uses=1 type=i8*] [debug line = 33:2]
  %state.load.8 = load i8* %state.addr.7, align 1, !dbg !2754 ; [#uses=2 type=i8] [debug line = 33:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.8) nounwind
  %tmp_state.addr.8 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 8, !dbg !2754 ; [#uses=1 type=i8*] [debug line = 33:2]
  store i8 %state.load.8, i8* %tmp_state.addr.8, align 8, !dbg !2754 ; [debug line = 33:2]
  %state.addr.8 = getelementptr inbounds i8* %state, i64 13, !dbg !2755 ; [#uses=1 type=i8*] [debug line = 34:2]
  %state.load.9 = load i8* %state.addr.8, align 1, !dbg !2755 ; [#uses=2 type=i8] [debug line = 34:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.9) nounwind
  %tmp_state.addr.9 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 9, !dbg !2755 ; [#uses=1 type=i8*] [debug line = 34:2]
  store i8 %state.load.9, i8* %tmp_state.addr.9, align 1, !dbg !2755 ; [debug line = 34:2]
  %state.addr.9 = getelementptr inbounds i8* %state, i64 2, !dbg !2756 ; [#uses=1 type=i8*] [debug line = 35:2]
  %state.load.10 = load i8* %state.addr.9, align 1, !dbg !2756 ; [#uses=2 type=i8] [debug line = 35:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.10) nounwind
  %tmp_state.addr.10 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 10, !dbg !2756 ; [#uses=1 type=i8*] [debug line = 35:2]
  store i8 %state.load.10, i8* %tmp_state.addr.10, align 2, !dbg !2756 ; [debug line = 35:2]
  %state.addr.10 = getelementptr inbounds i8* %state, i64 7, !dbg !2757 ; [#uses=1 type=i8*] [debug line = 36:2]
  %state.load.11 = load i8* %state.addr.10, align 1, !dbg !2757 ; [#uses=2 type=i8] [debug line = 36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.11) nounwind
  %tmp_state.addr.11 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 11, !dbg !2757 ; [#uses=1 type=i8*] [debug line = 36:2]
  store i8 %state.load.11, i8* %tmp_state.addr.11, align 1, !dbg !2757 ; [debug line = 36:2]
  %state.addr.11 = getelementptr inbounds i8* %state, i64 12, !dbg !2758 ; [#uses=1 type=i8*] [debug line = 38:2]
  %state.load.12 = load i8* %state.addr.11, align 1, !dbg !2758 ; [#uses=2 type=i8] [debug line = 38:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.12) nounwind
  %tmp_state.addr.12 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 12, !dbg !2758 ; [#uses=1 type=i8*] [debug line = 38:2]
  store i8 %state.load.12, i8* %tmp_state.addr.12, align 4, !dbg !2758 ; [debug line = 38:2]
  %state.addr.12 = getelementptr inbounds i8* %state, i64 1, !dbg !2759 ; [#uses=1 type=i8*] [debug line = 39:2]
  %state.load.13 = load i8* %state.addr.12, align 1, !dbg !2759 ; [#uses=2 type=i8] [debug line = 39:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.13) nounwind
  %tmp_state.addr.13 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 13, !dbg !2759 ; [#uses=1 type=i8*] [debug line = 39:2]
  store i8 %state.load.13, i8* %tmp_state.addr.13, align 1, !dbg !2759 ; [debug line = 39:2]
  %state.addr.13 = getelementptr inbounds i8* %state, i64 6, !dbg !2760 ; [#uses=1 type=i8*] [debug line = 40:2]
  %state.load.14 = load i8* %state.addr.13, align 1, !dbg !2760 ; [#uses=2 type=i8] [debug line = 40:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.14) nounwind
  %tmp_state.addr.14 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 14, !dbg !2760 ; [#uses=1 type=i8*] [debug line = 40:2]
  store i8 %state.load.14, i8* %tmp_state.addr.14, align 2, !dbg !2760 ; [debug line = 40:2]
  %state.addr.14 = getelementptr inbounds i8* %state, i64 11, !dbg !2761 ; [#uses=1 type=i8*] [debug line = 41:2]
  %state.load.15 = load i8* %state.addr.14, align 1, !dbg !2761 ; [#uses=2 type=i8] [debug line = 41:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.15) nounwind
  %tmp_state.addr.15 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 15, !dbg !2761 ; [#uses=1 type=i8*] [debug line = 41:2]
  store i8 %state.load.15, i8* %tmp_state.addr.15, align 1, !dbg !2761 ; [debug line = 41:2]
  br label %1, !dbg !2762                         ; [debug line = 42:27]

; <label>:1                                       ; preds = %2, %0
  %i = phi i16 [ 0, %0 ], [ %i.2, %2 ]            ; [#uses=3 type=i16]
  %tmp = icmp eq i16 %i, 16, !dbg !2762           ; [#uses=1 type=i1] [debug line = 42:27]
  br i1 %tmp, label %3, label %2, !dbg !2762      ; [debug line = 42:27]

; <label>:2                                       ; preds = %1
  %tmp.4 = zext i16 %i to i64, !dbg !2764         ; [#uses=2 type=i64] [debug line = 43:3]
  %tmp_state.addr.16 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 %tmp.4, !dbg !2764 ; [#uses=1 type=i8*] [debug line = 43:3]
  %tmp_state.load = load i8* %tmp_state.addr.16, align 1, !dbg !2764 ; [#uses=2 type=i8] [debug line = 43:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %tmp_state.load) nounwind
  %state.addr.15 = getelementptr inbounds i8* %state, i64 %tmp.4, !dbg !2764 ; [#uses=1 type=i8*] [debug line = 43:3]
  store i8 %tmp_state.load, i8* %state.addr.15, align 1, !dbg !2764 ; [debug line = 43:3]
  %i.2 = add i16 %i, 1, !dbg !2766                ; [#uses=1 type=i16] [debug line = 42:42]
  call void @llvm.dbg.value(metadata !{i16 %i.2}, i64 0, metadata !2767), !dbg !2766 ; [debug line = 42:42] [debug variable = i]
  br label %1, !dbg !2766                         ; [debug line = 42:42]

; <label>:3                                       ; preds = %1
  ret void, !dbg !2768                            ; [debug line = 45:1]
}

; [#uses=1]
define internal fastcc void @MixColumns(i8* %state) nounwind uwtable noinline {
  %tmp_state = alloca [16 x i8], align 16         ; [#uses=17 type=[16 x i8]*]
  call void @llvm.dbg.value(metadata !{i8* %state}, i64 0, metadata !2769), !dbg !2770 ; [debug line = 74:32] [debug variable = state]
  call void (...)* @_ssdm_InlineSelf(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2771 ; [debug line = 75:1]
  call void @llvm.dbg.declare(metadata !{[16 x i8]* %tmp_state}, metadata !2773), !dbg !2774 ; [debug line = 76:16] [debug variable = tmp_state]
  %state.load = load i8* %state, align 1, !dbg !2775 ; [#uses=7 type=i8] [debug line = 77:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load) nounwind
  %tmp = zext i8 %state.load to i64, !dbg !2775   ; [#uses=2 type=i64] [debug line = 77:2]
  %mul02.addr = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp, !dbg !2775 ; [#uses=1 type=i8*] [debug line = 77:2]
  %mul02.load = load i8* %mul02.addr, align 1, !dbg !2775 ; [#uses=2 type=i8] [debug line = 77:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load) nounwind
  %state.addr = getelementptr inbounds i8* %state, i64 1, !dbg !2775 ; [#uses=1 type=i8*] [debug line = 77:2]
  %state.load.16 = load i8* %state.addr, align 1, !dbg !2775 ; [#uses=7 type=i8] [debug line = 77:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.16) nounwind
  %tmp.6 = zext i8 %state.load.16 to i64, !dbg !2775 ; [#uses=2 type=i64] [debug line = 77:2]
  %mul03.addr = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.6, !dbg !2775 ; [#uses=1 type=i8*] [debug line = 77:2]
  %mul03.load = load i8* %mul03.addr, align 1, !dbg !2775 ; [#uses=2 type=i8] [debug line = 77:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load) nounwind
  %state.addr.16 = getelementptr inbounds i8* %state, i64 2, !dbg !2775 ; [#uses=1 type=i8*] [debug line = 77:2]
  %state.load.17 = load i8* %state.addr.16, align 1, !dbg !2775 ; [#uses=7 type=i8] [debug line = 77:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.17) nounwind
  %state.addr.17 = getelementptr inbounds i8* %state, i64 3, !dbg !2775 ; [#uses=1 type=i8*] [debug line = 77:2]
  %state.load.18 = load i8* %state.addr.17, align 1, !dbg !2775 ; [#uses=7 type=i8] [debug line = 77:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.18) nounwind
  %tmp.7 = xor i8 %mul03.load, %mul02.load, !dbg !2775 ; [#uses=1 type=i8] [debug line = 77:2]
  %tmp.8 = xor i8 %tmp.7, %state.load.17, !dbg !2775 ; [#uses=1 type=i8] [debug line = 77:2]
  %tmp.9 = xor i8 %tmp.8, %state.load.18, !dbg !2775 ; [#uses=1 type=i8] [debug line = 77:2]
  %tmp_state.addr = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 0, !dbg !2775 ; [#uses=1 type=i8*] [debug line = 77:2]
  store i8 %tmp.9, i8* %tmp_state.addr, align 16, !dbg !2775 ; [debug line = 77:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.16) nounwind
  %mul02.addr.1 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.6, !dbg !2776 ; [#uses=1 type=i8*] [debug line = 78:2]
  %mul02.load.1 = load i8* %mul02.addr.1, align 1, !dbg !2776 ; [#uses=2 type=i8] [debug line = 78:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.1) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.17) nounwind
  %tmp.10 = zext i8 %state.load.17 to i64, !dbg !2776 ; [#uses=2 type=i64] [debug line = 78:2]
  %mul03.addr.1 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.10, !dbg !2776 ; [#uses=1 type=i8*] [debug line = 78:2]
  %mul03.load.1 = load i8* %mul03.addr.1, align 1, !dbg !2776 ; [#uses=2 type=i8] [debug line = 78:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.1) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.18) nounwind
  %tmp.11 = xor i8 %state.load.18, %state.load, !dbg !2776 ; [#uses=1 type=i8] [debug line = 78:2]
  %tmp.12 = xor i8 %tmp.11, %mul02.load.1, !dbg !2776 ; [#uses=1 type=i8] [debug line = 78:2]
  %tmp.13 = xor i8 %tmp.12, %mul03.load.1, !dbg !2776 ; [#uses=1 type=i8] [debug line = 78:2]
  %tmp_state.addr.17 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 1, !dbg !2776 ; [#uses=1 type=i8*] [debug line = 78:2]
  store i8 %tmp.13, i8* %tmp_state.addr.17, align 1, !dbg !2776 ; [debug line = 78:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.16) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.17) nounwind
  %mul02.addr.2 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.10, !dbg !2777 ; [#uses=1 type=i8*] [debug line = 79:2]
  %mul02.load.2 = load i8* %mul02.addr.2, align 1, !dbg !2777 ; [#uses=2 type=i8] [debug line = 79:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.2) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.18) nounwind
  %tmp.14 = zext i8 %state.load.18 to i64, !dbg !2777 ; [#uses=2 type=i64] [debug line = 79:2]
  %mul03.addr.2 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.14, !dbg !2777 ; [#uses=1 type=i8*] [debug line = 79:2]
  %mul03.load.2 = load i8* %mul03.addr.2, align 1, !dbg !2777 ; [#uses=2 type=i8] [debug line = 79:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.2) nounwind
  %tmp.15 = xor i8 %state.load.16, %state.load, !dbg !2777 ; [#uses=1 type=i8] [debug line = 79:2]
  %tmp.16 = xor i8 %tmp.15, %mul02.load.2, !dbg !2777 ; [#uses=1 type=i8] [debug line = 79:2]
  %tmp.17 = xor i8 %tmp.16, %mul03.load.2, !dbg !2777 ; [#uses=1 type=i8] [debug line = 79:2]
  %tmp_state.addr.18 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 2, !dbg !2777 ; [#uses=1 type=i8*] [debug line = 79:2]
  store i8 %tmp.17, i8* %tmp_state.addr.18, align 2, !dbg !2777 ; [debug line = 79:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load) nounwind
  %mul03.addr.3 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp, !dbg !2778 ; [#uses=1 type=i8*] [debug line = 80:2]
  %mul03.load.3 = load i8* %mul03.addr.3, align 1, !dbg !2778 ; [#uses=2 type=i8] [debug line = 80:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.3) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.16) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.17) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.18) nounwind
  %mul02.addr.3 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.14, !dbg !2778 ; [#uses=1 type=i8*] [debug line = 80:2]
  %mul02.load.3 = load i8* %mul02.addr.3, align 1, !dbg !2778 ; [#uses=2 type=i8] [debug line = 80:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.3) nounwind
  %tmp.18 = xor i8 %state.load.17, %state.load.16, !dbg !2778 ; [#uses=1 type=i8] [debug line = 80:2]
  %tmp.19 = xor i8 %tmp.18, %mul03.load.3, !dbg !2778 ; [#uses=1 type=i8] [debug line = 80:2]
  %tmp.20 = xor i8 %tmp.19, %mul02.load.3, !dbg !2778 ; [#uses=1 type=i8] [debug line = 80:2]
  %tmp_state.addr.19 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 3, !dbg !2778 ; [#uses=1 type=i8*] [debug line = 80:2]
  store i8 %tmp.20, i8* %tmp_state.addr.19, align 1, !dbg !2778 ; [debug line = 80:2]
  %state.addr.18 = getelementptr inbounds i8* %state, i64 4, !dbg !2779 ; [#uses=1 type=i8*] [debug line = 82:2]
  %state.load.19 = load i8* %state.addr.18, align 1, !dbg !2779 ; [#uses=7 type=i8] [debug line = 82:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.19) nounwind
  %tmp.21 = zext i8 %state.load.19 to i64, !dbg !2779 ; [#uses=2 type=i64] [debug line = 82:2]
  %mul02.addr.4 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.21, !dbg !2779 ; [#uses=1 type=i8*] [debug line = 82:2]
  %mul02.load.4 = load i8* %mul02.addr.4, align 1, !dbg !2779 ; [#uses=2 type=i8] [debug line = 82:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.4) nounwind
  %state.addr.19 = getelementptr inbounds i8* %state, i64 5, !dbg !2779 ; [#uses=1 type=i8*] [debug line = 82:2]
  %state.load.20 = load i8* %state.addr.19, align 1, !dbg !2779 ; [#uses=7 type=i8] [debug line = 82:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.20) nounwind
  %tmp.22 = zext i8 %state.load.20 to i64, !dbg !2779 ; [#uses=2 type=i64] [debug line = 82:2]
  %mul03.addr.4 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.22, !dbg !2779 ; [#uses=1 type=i8*] [debug line = 82:2]
  %mul03.load.4 = load i8* %mul03.addr.4, align 1, !dbg !2779 ; [#uses=2 type=i8] [debug line = 82:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.4) nounwind
  %state.addr.20 = getelementptr inbounds i8* %state, i64 6, !dbg !2779 ; [#uses=1 type=i8*] [debug line = 82:2]
  %state.load.21 = load i8* %state.addr.20, align 1, !dbg !2779 ; [#uses=7 type=i8] [debug line = 82:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.21) nounwind
  %state.addr.21 = getelementptr inbounds i8* %state, i64 7, !dbg !2779 ; [#uses=1 type=i8*] [debug line = 82:2]
  %state.load.22 = load i8* %state.addr.21, align 1, !dbg !2779 ; [#uses=7 type=i8] [debug line = 82:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.22) nounwind
  %tmp.23 = xor i8 %mul03.load.4, %mul02.load.4, !dbg !2779 ; [#uses=1 type=i8] [debug line = 82:2]
  %tmp.24 = xor i8 %tmp.23, %state.load.21, !dbg !2779 ; [#uses=1 type=i8] [debug line = 82:2]
  %tmp.25 = xor i8 %tmp.24, %state.load.22, !dbg !2779 ; [#uses=1 type=i8] [debug line = 82:2]
  %tmp_state.addr.20 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 4, !dbg !2779 ; [#uses=1 type=i8*] [debug line = 82:2]
  store i8 %tmp.25, i8* %tmp_state.addr.20, align 4, !dbg !2779 ; [debug line = 82:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.19) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.20) nounwind
  %mul02.addr.5 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.22, !dbg !2780 ; [#uses=1 type=i8*] [debug line = 83:2]
  %mul02.load.5 = load i8* %mul02.addr.5, align 1, !dbg !2780 ; [#uses=2 type=i8] [debug line = 83:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.5) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.21) nounwind
  %tmp.26 = zext i8 %state.load.21 to i64, !dbg !2780 ; [#uses=2 type=i64] [debug line = 83:2]
  %mul03.addr.5 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.26, !dbg !2780 ; [#uses=1 type=i8*] [debug line = 83:2]
  %mul03.load.5 = load i8* %mul03.addr.5, align 1, !dbg !2780 ; [#uses=2 type=i8] [debug line = 83:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.5) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.22) nounwind
  %tmp.27 = xor i8 %state.load.22, %state.load.19, !dbg !2780 ; [#uses=1 type=i8] [debug line = 83:2]
  %tmp.28 = xor i8 %tmp.27, %mul02.load.5, !dbg !2780 ; [#uses=1 type=i8] [debug line = 83:2]
  %tmp.29 = xor i8 %tmp.28, %mul03.load.5, !dbg !2780 ; [#uses=1 type=i8] [debug line = 83:2]
  %tmp_state.addr.21 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 5, !dbg !2780 ; [#uses=1 type=i8*] [debug line = 83:2]
  store i8 %tmp.29, i8* %tmp_state.addr.21, align 1, !dbg !2780 ; [debug line = 83:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.19) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.20) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.21) nounwind
  %mul02.addr.6 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.26, !dbg !2781 ; [#uses=1 type=i8*] [debug line = 84:2]
  %mul02.load.6 = load i8* %mul02.addr.6, align 1, !dbg !2781 ; [#uses=2 type=i8] [debug line = 84:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.6) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.22) nounwind
  %tmp.30 = zext i8 %state.load.22 to i64, !dbg !2781 ; [#uses=2 type=i64] [debug line = 84:2]
  %mul03.addr.6 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.30, !dbg !2781 ; [#uses=1 type=i8*] [debug line = 84:2]
  %mul03.load.6 = load i8* %mul03.addr.6, align 1, !dbg !2781 ; [#uses=2 type=i8] [debug line = 84:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.6) nounwind
  %tmp.31 = xor i8 %state.load.20, %state.load.19, !dbg !2781 ; [#uses=1 type=i8] [debug line = 84:2]
  %tmp.32 = xor i8 %tmp.31, %mul02.load.6, !dbg !2781 ; [#uses=1 type=i8] [debug line = 84:2]
  %tmp.33 = xor i8 %tmp.32, %mul03.load.6, !dbg !2781 ; [#uses=1 type=i8] [debug line = 84:2]
  %tmp_state.addr.22 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 6, !dbg !2781 ; [#uses=1 type=i8*] [debug line = 84:2]
  store i8 %tmp.33, i8* %tmp_state.addr.22, align 2, !dbg !2781 ; [debug line = 84:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.19) nounwind
  %mul03.addr.7 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.21, !dbg !2782 ; [#uses=1 type=i8*] [debug line = 85:2]
  %mul03.load.7 = load i8* %mul03.addr.7, align 1, !dbg !2782 ; [#uses=2 type=i8] [debug line = 85:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.7) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.20) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.21) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.22) nounwind
  %mul02.addr.7 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.30, !dbg !2782 ; [#uses=1 type=i8*] [debug line = 85:2]
  %mul02.load.7 = load i8* %mul02.addr.7, align 1, !dbg !2782 ; [#uses=2 type=i8] [debug line = 85:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.7) nounwind
  %tmp.34 = xor i8 %state.load.21, %state.load.20, !dbg !2782 ; [#uses=1 type=i8] [debug line = 85:2]
  %tmp.35 = xor i8 %tmp.34, %mul03.load.7, !dbg !2782 ; [#uses=1 type=i8] [debug line = 85:2]
  %tmp.36 = xor i8 %tmp.35, %mul02.load.7, !dbg !2782 ; [#uses=1 type=i8] [debug line = 85:2]
  %tmp_state.addr.23 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 7, !dbg !2782 ; [#uses=1 type=i8*] [debug line = 85:2]
  store i8 %tmp.36, i8* %tmp_state.addr.23, align 1, !dbg !2782 ; [debug line = 85:2]
  %state.addr.22 = getelementptr inbounds i8* %state, i64 8, !dbg !2783 ; [#uses=1 type=i8*] [debug line = 87:2]
  %state.load.23 = load i8* %state.addr.22, align 1, !dbg !2783 ; [#uses=7 type=i8] [debug line = 87:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.23) nounwind
  %tmp.37 = zext i8 %state.load.23 to i64, !dbg !2783 ; [#uses=2 type=i64] [debug line = 87:2]
  %mul02.addr.8 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.37, !dbg !2783 ; [#uses=1 type=i8*] [debug line = 87:2]
  %mul02.load.8 = load i8* %mul02.addr.8, align 1, !dbg !2783 ; [#uses=2 type=i8] [debug line = 87:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.8) nounwind
  %state.addr.23 = getelementptr inbounds i8* %state, i64 9, !dbg !2783 ; [#uses=1 type=i8*] [debug line = 87:2]
  %state.load.24 = load i8* %state.addr.23, align 1, !dbg !2783 ; [#uses=7 type=i8] [debug line = 87:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.24) nounwind
  %tmp.38 = zext i8 %state.load.24 to i64, !dbg !2783 ; [#uses=2 type=i64] [debug line = 87:2]
  %mul03.addr.8 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.38, !dbg !2783 ; [#uses=1 type=i8*] [debug line = 87:2]
  %mul03.load.8 = load i8* %mul03.addr.8, align 1, !dbg !2783 ; [#uses=2 type=i8] [debug line = 87:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.8) nounwind
  %state.addr.24 = getelementptr inbounds i8* %state, i64 10, !dbg !2783 ; [#uses=1 type=i8*] [debug line = 87:2]
  %state.load.25 = load i8* %state.addr.24, align 1, !dbg !2783 ; [#uses=7 type=i8] [debug line = 87:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.25) nounwind
  %state.addr.25 = getelementptr inbounds i8* %state, i64 11, !dbg !2783 ; [#uses=1 type=i8*] [debug line = 87:2]
  %state.load.26 = load i8* %state.addr.25, align 1, !dbg !2783 ; [#uses=7 type=i8] [debug line = 87:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.26) nounwind
  %tmp.39 = xor i8 %mul03.load.8, %mul02.load.8, !dbg !2783 ; [#uses=1 type=i8] [debug line = 87:2]
  %tmp.40 = xor i8 %tmp.39, %state.load.25, !dbg !2783 ; [#uses=1 type=i8] [debug line = 87:2]
  %tmp.41 = xor i8 %tmp.40, %state.load.26, !dbg !2783 ; [#uses=1 type=i8] [debug line = 87:2]
  %tmp_state.addr.24 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 8, !dbg !2783 ; [#uses=1 type=i8*] [debug line = 87:2]
  store i8 %tmp.41, i8* %tmp_state.addr.24, align 8, !dbg !2783 ; [debug line = 87:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.23) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.24) nounwind
  %mul02.addr.9 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.38, !dbg !2784 ; [#uses=1 type=i8*] [debug line = 88:2]
  %mul02.load.9 = load i8* %mul02.addr.9, align 1, !dbg !2784 ; [#uses=2 type=i8] [debug line = 88:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.9) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.25) nounwind
  %tmp.42 = zext i8 %state.load.25 to i64, !dbg !2784 ; [#uses=2 type=i64] [debug line = 88:2]
  %mul03.addr.9 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.42, !dbg !2784 ; [#uses=1 type=i8*] [debug line = 88:2]
  %mul03.load.9 = load i8* %mul03.addr.9, align 1, !dbg !2784 ; [#uses=2 type=i8] [debug line = 88:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.9) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.26) nounwind
  %tmp.43 = xor i8 %state.load.26, %state.load.23, !dbg !2784 ; [#uses=1 type=i8] [debug line = 88:2]
  %tmp.44 = xor i8 %tmp.43, %mul02.load.9, !dbg !2784 ; [#uses=1 type=i8] [debug line = 88:2]
  %tmp.45 = xor i8 %tmp.44, %mul03.load.9, !dbg !2784 ; [#uses=1 type=i8] [debug line = 88:2]
  %tmp_state.addr.25 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 9, !dbg !2784 ; [#uses=1 type=i8*] [debug line = 88:2]
  store i8 %tmp.45, i8* %tmp_state.addr.25, align 1, !dbg !2784 ; [debug line = 88:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.23) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.24) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.25) nounwind
  %mul02.addr.10 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.42, !dbg !2785 ; [#uses=1 type=i8*] [debug line = 89:2]
  %mul02.load.10 = load i8* %mul02.addr.10, align 1, !dbg !2785 ; [#uses=2 type=i8] [debug line = 89:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.10) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.26) nounwind
  %tmp.46 = zext i8 %state.load.26 to i64, !dbg !2785 ; [#uses=2 type=i64] [debug line = 89:2]
  %mul03.addr.10 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.46, !dbg !2785 ; [#uses=1 type=i8*] [debug line = 89:2]
  %mul03.load.10 = load i8* %mul03.addr.10, align 1, !dbg !2785 ; [#uses=2 type=i8] [debug line = 89:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.10) nounwind
  %tmp.47 = xor i8 %state.load.24, %state.load.23, !dbg !2785 ; [#uses=1 type=i8] [debug line = 89:2]
  %tmp.48 = xor i8 %tmp.47, %mul02.load.10, !dbg !2785 ; [#uses=1 type=i8] [debug line = 89:2]
  %tmp.49 = xor i8 %tmp.48, %mul03.load.10, !dbg !2785 ; [#uses=1 type=i8] [debug line = 89:2]
  %tmp_state.addr.26 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 10, !dbg !2785 ; [#uses=1 type=i8*] [debug line = 89:2]
  store i8 %tmp.49, i8* %tmp_state.addr.26, align 2, !dbg !2785 ; [debug line = 89:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.23) nounwind
  %mul03.addr.11 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.37, !dbg !2786 ; [#uses=1 type=i8*] [debug line = 90:2]
  %mul03.load.11 = load i8* %mul03.addr.11, align 1, !dbg !2786 ; [#uses=2 type=i8] [debug line = 90:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.11) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.24) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.25) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.26) nounwind
  %mul02.addr.11 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.46, !dbg !2786 ; [#uses=1 type=i8*] [debug line = 90:2]
  %mul02.load.11 = load i8* %mul02.addr.11, align 1, !dbg !2786 ; [#uses=2 type=i8] [debug line = 90:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.11) nounwind
  %tmp.50 = xor i8 %state.load.25, %state.load.24, !dbg !2786 ; [#uses=1 type=i8] [debug line = 90:2]
  %tmp.51 = xor i8 %tmp.50, %mul03.load.11, !dbg !2786 ; [#uses=1 type=i8] [debug line = 90:2]
  %tmp.52 = xor i8 %tmp.51, %mul02.load.11, !dbg !2786 ; [#uses=1 type=i8] [debug line = 90:2]
  %tmp_state.addr.27 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 11, !dbg !2786 ; [#uses=1 type=i8*] [debug line = 90:2]
  store i8 %tmp.52, i8* %tmp_state.addr.27, align 1, !dbg !2786 ; [debug line = 90:2]
  %state.addr.26 = getelementptr inbounds i8* %state, i64 12, !dbg !2787 ; [#uses=1 type=i8*] [debug line = 92:2]
  %state.load.27 = load i8* %state.addr.26, align 1, !dbg !2787 ; [#uses=7 type=i8] [debug line = 92:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.27) nounwind
  %tmp.53 = zext i8 %state.load.27 to i64, !dbg !2787 ; [#uses=2 type=i64] [debug line = 92:2]
  %mul02.addr.12 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.53, !dbg !2787 ; [#uses=1 type=i8*] [debug line = 92:2]
  %mul02.load.12 = load i8* %mul02.addr.12, align 1, !dbg !2787 ; [#uses=2 type=i8] [debug line = 92:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.12) nounwind
  %state.addr.27 = getelementptr inbounds i8* %state, i64 13, !dbg !2787 ; [#uses=1 type=i8*] [debug line = 92:2]
  %state.load.28 = load i8* %state.addr.27, align 1, !dbg !2787 ; [#uses=7 type=i8] [debug line = 92:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.28) nounwind
  %tmp.54 = zext i8 %state.load.28 to i64, !dbg !2787 ; [#uses=2 type=i64] [debug line = 92:2]
  %mul03.addr.12 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.54, !dbg !2787 ; [#uses=1 type=i8*] [debug line = 92:2]
  %mul03.load.12 = load i8* %mul03.addr.12, align 1, !dbg !2787 ; [#uses=2 type=i8] [debug line = 92:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.12) nounwind
  %state.addr.28 = getelementptr inbounds i8* %state, i64 14, !dbg !2787 ; [#uses=1 type=i8*] [debug line = 92:2]
  %state.load.29 = load i8* %state.addr.28, align 1, !dbg !2787 ; [#uses=7 type=i8] [debug line = 92:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.29) nounwind
  %state.addr.29 = getelementptr inbounds i8* %state, i64 15, !dbg !2787 ; [#uses=1 type=i8*] [debug line = 92:2]
  %state.load.30 = load i8* %state.addr.29, align 1, !dbg !2787 ; [#uses=7 type=i8] [debug line = 92:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.30) nounwind
  %tmp.55 = xor i8 %mul03.load.12, %mul02.load.12, !dbg !2787 ; [#uses=1 type=i8] [debug line = 92:2]
  %tmp.56 = xor i8 %tmp.55, %state.load.29, !dbg !2787 ; [#uses=1 type=i8] [debug line = 92:2]
  %tmp.57 = xor i8 %tmp.56, %state.load.30, !dbg !2787 ; [#uses=1 type=i8] [debug line = 92:2]
  %tmp_state.addr.28 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 12, !dbg !2787 ; [#uses=1 type=i8*] [debug line = 92:2]
  store i8 %tmp.57, i8* %tmp_state.addr.28, align 4, !dbg !2787 ; [debug line = 92:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.27) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.28) nounwind
  %mul02.addr.13 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.54, !dbg !2788 ; [#uses=1 type=i8*] [debug line = 93:2]
  %mul02.load.13 = load i8* %mul02.addr.13, align 1, !dbg !2788 ; [#uses=2 type=i8] [debug line = 93:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.13) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.29) nounwind
  %tmp.58 = zext i8 %state.load.29 to i64, !dbg !2788 ; [#uses=2 type=i64] [debug line = 93:2]
  %mul03.addr.13 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.58, !dbg !2788 ; [#uses=1 type=i8*] [debug line = 93:2]
  %mul03.load.13 = load i8* %mul03.addr.13, align 1, !dbg !2788 ; [#uses=2 type=i8] [debug line = 93:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.13) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.30) nounwind
  %tmp.59 = xor i8 %state.load.30, %state.load.27, !dbg !2788 ; [#uses=1 type=i8] [debug line = 93:2]
  %tmp.60 = xor i8 %tmp.59, %mul02.load.13, !dbg !2788 ; [#uses=1 type=i8] [debug line = 93:2]
  %tmp.61 = xor i8 %tmp.60, %mul03.load.13, !dbg !2788 ; [#uses=1 type=i8] [debug line = 93:2]
  %tmp_state.addr.29 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 13, !dbg !2788 ; [#uses=1 type=i8*] [debug line = 93:2]
  store i8 %tmp.61, i8* %tmp_state.addr.29, align 1, !dbg !2788 ; [debug line = 93:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.27) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.28) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.29) nounwind
  %mul02.addr.14 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.58, !dbg !2789 ; [#uses=1 type=i8*] [debug line = 94:2]
  %mul02.load.14 = load i8* %mul02.addr.14, align 1, !dbg !2789 ; [#uses=2 type=i8] [debug line = 94:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.14) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.30) nounwind
  %tmp.62 = zext i8 %state.load.30 to i64, !dbg !2789 ; [#uses=2 type=i64] [debug line = 94:2]
  %mul03.addr.14 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.62, !dbg !2789 ; [#uses=1 type=i8*] [debug line = 94:2]
  %mul03.load.14 = load i8* %mul03.addr.14, align 1, !dbg !2789 ; [#uses=2 type=i8] [debug line = 94:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.14) nounwind
  %tmp.63 = xor i8 %state.load.28, %state.load.27, !dbg !2789 ; [#uses=1 type=i8] [debug line = 94:2]
  %tmp.64 = xor i8 %tmp.63, %mul02.load.14, !dbg !2789 ; [#uses=1 type=i8] [debug line = 94:2]
  %tmp.65 = xor i8 %tmp.64, %mul03.load.14, !dbg !2789 ; [#uses=1 type=i8] [debug line = 94:2]
  %tmp_state.addr.30 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 14, !dbg !2789 ; [#uses=1 type=i8*] [debug line = 94:2]
  store i8 %tmp.65, i8* %tmp_state.addr.30, align 2, !dbg !2789 ; [debug line = 94:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.27) nounwind
  %mul03.addr.15 = getelementptr inbounds [256 x i8]* @mul03, i64 0, i64 %tmp.53, !dbg !2790 ; [#uses=1 type=i8*] [debug line = 95:2]
  %mul03.load.15 = load i8* %mul03.addr.15, align 1, !dbg !2790 ; [#uses=2 type=i8] [debug line = 95:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul03.load.15) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.28) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.29) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load.30) nounwind
  %mul02.addr.15 = getelementptr inbounds [256 x i8]* @mul02, i64 0, i64 %tmp.62, !dbg !2790 ; [#uses=1 type=i8*] [debug line = 95:2]
  %mul02.load.15 = load i8* %mul02.addr.15, align 1, !dbg !2790 ; [#uses=2 type=i8] [debug line = 95:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %mul02.load.15) nounwind
  %tmp.66 = xor i8 %state.load.29, %state.load.28, !dbg !2790 ; [#uses=1 type=i8] [debug line = 95:2]
  %tmp.67 = xor i8 %tmp.66, %mul03.load.15, !dbg !2790 ; [#uses=1 type=i8] [debug line = 95:2]
  %tmp.68 = xor i8 %tmp.67, %mul02.load.15, !dbg !2790 ; [#uses=1 type=i8] [debug line = 95:2]
  %tmp_state.addr.31 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 15, !dbg !2790 ; [#uses=1 type=i8*] [debug line = 95:2]
  store i8 %tmp.68, i8* %tmp_state.addr.31, align 1, !dbg !2790 ; [debug line = 95:2]
  br label %1, !dbg !2791                         ; [debug line = 96:27]

; <label>:1                                       ; preds = %2, %0
  %i = phi i16 [ 0, %0 ], [ %i.3, %2 ]            ; [#uses=3 type=i16]
  %tmp.69 = icmp eq i16 %i, 16, !dbg !2791        ; [#uses=1 type=i1] [debug line = 96:27]
  br i1 %tmp.69, label %3, label %2, !dbg !2791   ; [debug line = 96:27]

; <label>:2                                       ; preds = %1
  %tmp.70 = zext i16 %i to i64, !dbg !2793        ; [#uses=2 type=i64] [debug line = 97:3]
  %tmp_state.addr.32 = getelementptr inbounds [16 x i8]* %tmp_state, i64 0, i64 %tmp.70, !dbg !2793 ; [#uses=1 type=i8*] [debug line = 97:3]
  %tmp_state.load = load i8* %tmp_state.addr.32, align 1, !dbg !2793 ; [#uses=2 type=i8] [debug line = 97:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %tmp_state.load) nounwind
  %state.addr.30 = getelementptr inbounds i8* %state, i64 %tmp.70, !dbg !2793 ; [#uses=1 type=i8*] [debug line = 97:3]
  store i8 %tmp_state.load, i8* %state.addr.30, align 1, !dbg !2793 ; [debug line = 97:3]
  %i.3 = add i16 %i, 1, !dbg !2795                ; [#uses=1 type=i16] [debug line = 96:42]
  call void @llvm.dbg.value(metadata !{i16 %i.3}, i64 0, metadata !2796), !dbg !2795 ; [debug line = 96:42] [debug variable = i]
  br label %1, !dbg !2795                         ; [debug line = 96:42]

; <label>:3                                       ; preds = %1
  ret void, !dbg !2797                            ; [debug line = 99:1]
}
...
define void @AES_Encrypt(i8* %plaintext, i8* %expandedKey, i16 zeroext %Nr, i8* %ciphertext) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i8* %plaintext}, i64 0, metadata !2814), !dbg !2815 ; [debug line = 153:32] [debug variable = plaintext]
  call void @llvm.dbg.value(metadata !{i8* %expandedKey}, i64 0, metadata !2816), !dbg !2817 ; [debug line = 154:17] [debug variable = expandedKey]
  call void @llvm.dbg.value(metadata !{i16 %Nr}, i64 0, metadata !2818), !dbg !2819 ; [debug line = 154:71] [debug variable = Nr]
  call void @llvm.dbg.value(metadata !{i8* %ciphertext}, i64 0, metadata !2820), !dbg !2821 ; [debug line = 155:17] [debug variable = ciphertext]
  call void (...)* @_ssdm_SpecArrayDimSize(i8* %ciphertext, i32 16) nounwind, !dbg !2822 ; [debug line = 155:39]
  call void (...)* @_ssdm_SpecArrayDimSize(i8* %plaintext, i32 16) nounwind, !dbg !2824 ; [debug line = 155:82]
  call void (...)* @_ssdm_SpecArrayDimSize(i8* %expandedKey, i32 240) nounwind, !dbg !2825 ; [debug line = 155:124]
  call void (...)* @_ssdm_op_SpecInterface(i8* %plaintext, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2826 ; [debug line = 156:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %expandedKey, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2827 ; [debug line = 157:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %ciphertext, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2828 ; [debug line = 158:1]
  call void (...)* @_ssdm_op_SpecResourceLimit(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2829 ; [debug line = 161:1]
  call void (...)* @_ssdm_SpecArrayMap(i8* getelementptr inbounds ([256 x i8]* @s_box, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([11 x i8]* @.str8, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2830 ; [debug line = 162:1]
  call void (...)* @_ssdm_SpecArrayMap(i8* getelementptr inbounds ([256 x i8]* @mul02, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([11 x i8]* @.str8, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2831 ; [debug line = 163:1]
  call void (...)* @_ssdm_SpecArrayMap(i8* getelementptr inbounds ([256 x i8]* @mul03, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([11 x i8]* @.str8, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2832 ; [debug line = 164:1]
  call void @llvm.dbg.declare(metadata !{[16 x i8]* %state}, metadata !2833), !dbg !2834 ; [debug line = 167:16] [debug variable = state]
  br label %1, !dbg !2835                         ; [debug line = 168:35]

; <label>:1                                       ; preds = %2, %0
  %i = phi i16 [ 0, %0 ], [ %i.5, %2 ]            ; [#uses=3 type=i16]
  %tmp = icmp eq i16 %i, 16, !dbg !2835           ; [#uses=1 type=i1] [debug line = 168:35]
  br i1 %tmp, label %3, label %2, !dbg !2835      ; [debug line = 168:35]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([7 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !2837 ; [debug line = 168:56]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([7 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !2837 ; [#uses=1 type=i32] [debug line = 168:56]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2839 ; [debug line = 169:1]
  %tmp.77 = zext i16 %i to i64, !dbg !2840        ; [#uses=2 type=i64] [debug line = 170:2]
  %plaintext.addr = getelementptr inbounds i8* %plaintext, i64 %tmp.77, !dbg !2840 ; [#uses=1 type=i8*] [debug line = 170:2]
  %plaintext.load = load i8* %plaintext.addr, align 1, !dbg !2840 ; [#uses=2 type=i8] [debug line = 170:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %plaintext.load) nounwind
  %state.addr.31 = getelementptr inbounds [16 x i8]* %state, i64 0, i64 %tmp.77, !dbg !2840 ; [#uses=1 type=i8*] [debug line = 170:2]
  store i8 %plaintext.load, i8* %state.addr.31, align 1, !dbg !2840 ; [debug line = 170:2]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([7 x i8]* @.str9, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2841 ; [#uses=0 type=i32] [debug line = 171:2]
  %i.5 = add i16 %i, 1, !dbg !2842                ; [#uses=1 type=i16] [debug line = 168:50]
  call void @llvm.dbg.value(metadata !{i16 %i.5}, i64 0, metadata !2843), !dbg !2842 ; [debug line = 168:50] [debug variable = i]
  br label %1, !dbg !2842                         ; [debug line = 168:50]

; <label>:3                                       ; preds = %1
  %state.addr = getelementptr inbounds [16 x i8]* %state, i64 0, i64 0, !dbg !2844 ; [#uses=5 type=i8*] [debug line = 174:2]
  call fastcc void @AddRoundKey(i8* %state.addr, i8* %expandedKey), !dbg !2844 ; [debug line = 174:2]
  %tmp.75 = zext i16 %Nr to i32, !dbg !2845       ; [#uses=1 type=i32] [debug line = 180:3]
  %tmp.76 = add nsw i32 %tmp.75, -1, !dbg !2845   ; [#uses=1 type=i32] [debug line = 180:3]
  br label %4, !dbg !2848                         ; [debug line = 176:37]

; <label>:4                                       ; preds = %._crit_edge, %3
  %i1 = phi i16 [ 0, %3 ], [ %i.7, %._crit_edge ] ; [#uses=3 type=i16]
  %exitcond = icmp eq i16 %i1, %Nr, !dbg !2848    ; [#uses=1 type=i1] [debug line = 176:37]
  br i1 %exitcond, label %.preheader.preheader, label %5, !dbg !2848 ; [debug line = 176:37]

.preheader.preheader:                             ; preds = %4
  br label %.preheader, !dbg !2849                ; [debug line = 187:27]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !2851 ; [debug line = 176:53]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !2851 ; [#uses=1 type=i32] [debug line = 176:53]
  call fastcc void @SubBytes(i8* %state.addr), !dbg !2852 ; [debug line = 178:3]
  call fastcc void @ShiftRows(i8* %state.addr), !dbg !2853 ; [debug line = 179:3]
  %tmp.79 = zext i16 %i1 to i32, !dbg !2845       ; [#uses=2 type=i32] [debug line = 180:3]
  %tmp.80 = icmp eq i32 %tmp.79, %tmp.76, !dbg !2845 ; [#uses=1 type=i1] [debug line = 180:3]
  br i1 %tmp.80, label %._crit_edge, label %6, !dbg !2845 ; [debug line = 180:3]

; <label>:6                                       ; preds = %5
  call fastcc void @MixColumns(i8* %state.addr), !dbg !2854 ; [debug line = 181:4]
  br label %._crit_edge, !dbg !2856               ; [debug line = 182:3]

._crit_edge:                                      ; preds = %6, %5
  %tmp.84 = mul i32 %tmp.79, 16, !dbg !2857       ; [#uses=1 type=i32] [debug line = 183:3]
  %tmp.85 = add i32 %tmp.84, 16, !dbg !2857       ; [#uses=1 type=i32] [debug line = 183:3]
  %tmp.86 = zext i32 %tmp.85 to i64, !dbg !2857   ; [#uses=1 type=i64] [debug line = 183:3]
  %expandedKey.addr = getelementptr inbounds i8* %expandedKey, i64 %tmp.86, !dbg !2857 ; [#uses=1 type=i8*] [debug line = 183:3]
  call fastcc void @AddRoundKey(i8* %state.addr, i8* %expandedKey.addr), !dbg !2857 ; [debug line = 183:3]
  %rend2 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str10, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !2858 ; [#uses=0 type=i32] [debug line = 184:2]
  %i.7 = add i16 %i1, 1, !dbg !2859               ; [#uses=1 type=i16] [debug line = 176:47]
  call void @llvm.dbg.value(metadata !{i16 %i.7}, i64 0, metadata !2860), !dbg !2859 ; [debug line = 176:47] [debug variable = i]
  br label %4, !dbg !2859                         ; [debug line = 176:47]

.preheader:                                       ; preds = %7, %.preheader.preheader
  %i2 = phi i16 [ %i.6, %7 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i16]
  %tmp.81 = icmp eq i16 %i2, 16, !dbg !2849       ; [#uses=1 type=i1] [debug line = 187:27]
  br i1 %tmp.81, label %8, label %7, !dbg !2849   ; [debug line = 187:27]

; <label>:7                                       ; preds = %.preheader
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0)) nounwind, !dbg !2861 ; [#uses=1 type=i32] [debug line = 187:48]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2863 ; [debug line = 188:1]
  %tmp.82 = zext i16 %i2 to i64, !dbg !2864       ; [#uses=2 type=i64] [debug line = 189:2]
  %state.addr.32 = getelementptr inbounds [16 x i8]* %state, i64 0, i64 %tmp.82, !dbg !2864 ; [#uses=1 type=i8*] [debug line = 189:2]
  %state.load = load i8* %state.addr.32, align 1, !dbg !2864 ; [#uses=2 type=i8] [debug line = 189:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %state.load) nounwind
  %ciphertext.addr = getelementptr inbounds i8* %ciphertext, i64 %tmp.82, !dbg !2864 ; [#uses=1 type=i8*] [debug line = 189:2]
  store i8 %state.load, i8* %ciphertext.addr, align 1, !dbg !2864 ; [debug line = 189:2]
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !2865 ; [#uses=0 type=i32] [debug line = 190:2]
  %i.6 = add i16 %i2, 1, !dbg !2866               ; [#uses=1 type=i16] [debug line = 187:42]
  call void @llvm.dbg.value(metadata !{i16 %i.6}, i64 0, metadata !2867), !dbg !2866 ; [debug line = 187:42] [debug variable = i]
  br label %.preheader, !dbg !2866                ; [debug line = 187:42]

; <label>:8                                       ; preds = %.preheader
  ret void, !dbg !2868                            ; [debug line = 191:1]
}

!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!2695, !2702, !2703, !2702, !2704, !2702, !2705, !2711, !2717, !2719, !2719}
!hls.encrypted.func = !{}
...
!869 = metadata !{i32 786478, i32 0, metadata !870, metadata !"SubBytes", metadata !"SubBytes", metadata !"_Z8SubBytesPh", metadata !870, i32 4, metadata !871, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8*)* @SubBytes, null, null, metadata !87, i32 4} ; [ DW_TAG_subprogram ]
...
!876 = metadata !{i32 786478, i32 0, metadata !870, metadata !"ShiftRows", metadata !"ShiftRows", metadata !"_Z9ShiftRowsPh", metadata !870, i32 20, metadata !871, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8*)* @ShiftRows, null, null, metadata !87, i32 20} ; [ DW_TAG_subprogram ]
...
!878 = metadata !{i32 786478, i32 0, metadata !870, metadata !"MixColumns", metadata !"MixColumns", metadata !"_Z10MixColumnsPh", metadata !870, i32 74, metadata !871, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8*)* @MixColumns, null, null, metadata !87, i32 74} ; [ DW_TAG_subprogram ]
...
!883 = metadata !{i32 786478, i32 0, metadata !870, metadata !"AES_Encrypt", metadata !"AES_Encrypt", metadata !"_Z11AES_EncryptPhS_tS_", metadata !870, i32 153, metadata !884, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8*, i8*, i16, i8*)* @AES_Encrypt, null, null, metadata !87, i32 155} ; [ DW_TAG_subprogram ]
...
!2685 = metadata !{i32 786484, i32 0, null, metadata !"mul09", metadata !"mul09", metadata !"_ZL5mul09", metadata !2686, i32 99, metadata !2687, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!2688 = metadata !{i32 786484, i32 0, null, metadata !"mul13", metadata !"mul13", metadata !"_ZL5mul13", metadata !2686, i32 145, metadata !2687, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!2689 = metadata !{i32 786484, i32 0, null, metadata !"mul11", metadata !"mul11", metadata !"_ZL5mul11", metadata !2686, i32 122, metadata !2687, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!2690 = metadata !{i32 786484, i32 0, null, metadata !"mul14", metadata !"mul14", metadata !"_ZL5mul14", metadata !2686, i32 168, metadata !2687, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!2691 = metadata !{i32 786484, i32 0, null, metadata !"mul03", metadata !"mul03", metadata !"_ZL5mul03", metadata !2686, i32 76, metadata !2687, i32 1, i32 1, [256 x i8]* @mul03} ; [ DW_TAG_variable ]
!2692 = metadata !{i32 786484, i32 0, null, metadata !"mul02", metadata !"mul02", metadata !"_ZL5mul02", metadata !2686, i32 53, metadata !2687, i32 1, i32 1, [256 x i8]* @mul02} ; [ DW_TAG_variable ]
!2693 = metadata !{i32 786484, i32 0, null, metadata !"inverted_s_box", metadata !"inverted_s_box", metadata !"_ZL14inverted_s_box", metadata !2686, i32 28, metadata !2687, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!2694 = metadata !{i32 786484, i32 0, null, metadata !"s_box", metadata !"s_box", metadata !"_ZL5s_box", metadata !2686, i32 4, metadata !2687, i32 1, i32 1, [256 x i8]* @s_box} ; [ DW_TAG_variable ]
!2695 = metadata !{void (i8*)* @SubBytes, metadata !2696, metadata !2697, metadata !2698, metadata !2699, metadata !2700, metadata !2701}
...
!2703 = metadata !{void (i8*)* @ShiftRows, metadata !2696, metadata !2697, metadata !2698, metadata !2699, metadata !2700, metadata !2701}
!2704 = metadata !{void (i8*)* @MixColumns, metadata !2696, metadata !2697, metadata !2698, metadata !2699, metadata !2700, metadata !2701}
...
!2711 = metadata !{void (i8*, i8*, i16, i8*)* @AES_Encrypt, metadata !2712, metadata !2713, metadata !2714, metadata !2715, metadata !2716, metadata !2701}
...
!2725 = metadata !{i32 786689, metadata !869, metadata !"state", metadata !870, i32 16777220, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2726 = metadata !{i32 4, i32 30, metadata !869, null}
!2727 = metadata !{i32 5, i32 1, metadata !2728, null}
!2728 = metadata !{i32 786443, metadata !869, i32 4, i32 37, metadata !870, i32 0} ; [ DW_TAG_lexical_block ]
!2729 = metadata !{i32 6, i32 27, metadata !2730, null}
!2730 = metadata !{i32 786443, metadata !2728, i32 6, i32 2, metadata !870, i32 1} ; [ DW_TAG_lexical_block ]
!2731 = metadata !{i32 6, i32 48, metadata !2732, null}
!2732 = metadata !{i32 786443, metadata !2730, i32 6, i32 47, metadata !870, i32 2} ; [ DW_TAG_lexical_block ]
!2733 = metadata !{i32 7, i32 1, metadata !2732, null}
!2734 = metadata !{i32 8, i32 2, metadata !2732, null}
!2735 = metadata !{i32 9, i32 2, metadata !2732, null}
!2736 = metadata !{i32 6, i32 42, metadata !2730, null}
!2737 = metadata !{i32 786688, metadata !2730, metadata !"i", metadata !870, i32 6, metadata !886, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2738 = metadata !{i32 10, i32 1, metadata !2728, null}
!2739 = metadata !{i32 786689, metadata !876, metadata !"state", metadata !870, i32 16777236, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2740 = metadata !{i32 20, i32 31, metadata !876, null}
!2741 = metadata !{i32 21, i32 1, metadata !2742, null}
!2742 = metadata !{i32 786443, metadata !876, i32 20, i32 38, metadata !870, i32 6} ; [ DW_TAG_lexical_block ]
!2743 = metadata !{i32 786688, metadata !2742, metadata !"tmp_state", metadata !870, i32 22, metadata !2744, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2745 = metadata !{i32 22, i32 16, metadata !2742, null}
!2746 = metadata !{i32 23, i32 2, metadata !2742, null}
!2747 = metadata !{i32 24, i32 2, metadata !2742, null}
!2748 = metadata !{i32 25, i32 2, metadata !2742, null}
!2749 = metadata !{i32 26, i32 2, metadata !2742, null}
!2750 = metadata !{i32 28, i32 2, metadata !2742, null}
!2751 = metadata !{i32 29, i32 2, metadata !2742, null}
!2752 = metadata !{i32 30, i32 2, metadata !2742, null}
!2753 = metadata !{i32 31, i32 2, metadata !2742, null}
!2754 = metadata !{i32 33, i32 2, metadata !2742, null}
!2755 = metadata !{i32 34, i32 2, metadata !2742, null}
!2756 = metadata !{i32 35, i32 2, metadata !2742, null}
!2757 = metadata !{i32 36, i32 2, metadata !2742, null}
!2758 = metadata !{i32 38, i32 2, metadata !2742, null}
!2759 = metadata !{i32 39, i32 2, metadata !2742, null}
!2760 = metadata !{i32 40, i32 2, metadata !2742, null}
!2761 = metadata !{i32 41, i32 2, metadata !2742, null}
!2762 = metadata !{i32 42, i32 27, metadata !2763, null}
!2763 = metadata !{i32 786443, metadata !2742, i32 42, i32 2, metadata !870, i32 7} ; [ DW_TAG_lexical_block ]
!2764 = metadata !{i32 43, i32 3, metadata !2765, null}
!2765 = metadata !{i32 786443, metadata !2763, i32 42, i32 47, metadata !870, i32 8} ; [ DW_TAG_lexical_block ]
!2766 = metadata !{i32 42, i32 42, metadata !2763, null}
!2767 = metadata !{i32 786688, metadata !2763, metadata !"i", metadata !870, i32 42, metadata !886, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2768 = metadata !{i32 45, i32 1, metadata !2742, null}
!2769 = metadata !{i32 786689, metadata !878, metadata !"state", metadata !870, i32 16777290, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2770 = metadata !{i32 74, i32 32, metadata !878, null}
!2771 = metadata !{i32 75, i32 1, metadata !2772, null}
!2772 = metadata !{i32 786443, metadata !878, i32 74, i32 39, metadata !870, i32 12} ; [ DW_TAG_lexical_block ]
!2773 = metadata !{i32 786688, metadata !2772, metadata !"tmp_state", metadata !870, i32 76, metadata !2744, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2774 = metadata !{i32 76, i32 16, metadata !2772, null}
!2775 = metadata !{i32 77, i32 2, metadata !2772, null}
!2776 = metadata !{i32 78, i32 2, metadata !2772, null}
!2777 = metadata !{i32 79, i32 2, metadata !2772, null}
!2778 = metadata !{i32 80, i32 2, metadata !2772, null}
!2779 = metadata !{i32 82, i32 2, metadata !2772, null}
!2780 = metadata !{i32 83, i32 2, metadata !2772, null}
!2781 = metadata !{i32 84, i32 2, metadata !2772, null}
!2782 = metadata !{i32 85, i32 2, metadata !2772, null}
!2783 = metadata !{i32 87, i32 2, metadata !2772, null}
!2784 = metadata !{i32 88, i32 2, metadata !2772, null}
!2785 = metadata !{i32 89, i32 2, metadata !2772, null}
!2786 = metadata !{i32 90, i32 2, metadata !2772, null}
!2787 = metadata !{i32 92, i32 2, metadata !2772, null}
!2788 = metadata !{i32 93, i32 2, metadata !2772, null}
!2789 = metadata !{i32 94, i32 2, metadata !2772, null}
!2790 = metadata !{i32 95, i32 2, metadata !2772, null}
!2791 = metadata !{i32 96, i32 27, metadata !2792, null}
!2792 = metadata !{i32 786443, metadata !2772, i32 96, i32 2, metadata !870, i32 13} ; [ DW_TAG_lexical_block ]
!2793 = metadata !{i32 97, i32 3, metadata !2794, null}
!2794 = metadata !{i32 786443, metadata !2792, i32 96, i32 47, metadata !870, i32 14} ; [ DW_TAG_lexical_block ]
!2795 = metadata !{i32 96, i32 42, metadata !2792, null}
!2796 = metadata !{i32 786688, metadata !2792, metadata !"i", metadata !870, i32 96, metadata !886, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2797 = metadata !{i32 99, i32 1, metadata !2772, null}
...
!2814 = metadata !{i32 786689, metadata !883, metadata !"plaintext", metadata !870, i32 16777369, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2815 = metadata !{i32 153, i32 32, metadata !883, null}
!2816 = metadata !{i32 786689, metadata !883, metadata !"expandedKey", metadata !870, i32 33554586, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2817 = metadata !{i32 154, i32 17, metadata !883, null}
!2818 = metadata !{i32 786689, metadata !883, metadata !"Nr", metadata !870, i32 50331802, metadata !886, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2819 = metadata !{i32 154, i32 71, metadata !883, null}
!2820 = metadata !{i32 786689, metadata !883, metadata !"ciphertext", metadata !870, i32 67109019, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2821 = metadata !{i32 155, i32 17, metadata !883, null}
!2822 = metadata !{i32 155, i32 39, metadata !2823, null}
!2823 = metadata !{i32 786443, metadata !883, i32 155, i32 38, metadata !870, i32 21} ; [ DW_TAG_lexical_block ]
!2824 = metadata !{i32 155, i32 82, metadata !2823, null}
!2825 = metadata !{i32 155, i32 124, metadata !2823, null}
!2826 = metadata !{i32 156, i32 1, metadata !2823, null}
!2827 = metadata !{i32 157, i32 1, metadata !2823, null}
!2828 = metadata !{i32 158, i32 1, metadata !2823, null}
!2829 = metadata !{i32 161, i32 1, metadata !2823, null}
!2830 = metadata !{i32 162, i32 1, metadata !2823, null}
!2831 = metadata !{i32 163, i32 1, metadata !2823, null}
!2832 = metadata !{i32 164, i32 1, metadata !2823, null}
!2833 = metadata !{i32 786688, metadata !2823, metadata !"state", metadata !870, i32 167, metadata !2744, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2834 = metadata !{i32 167, i32 16, metadata !2823, null}
!2835 = metadata !{i32 168, i32 35, metadata !2836, null}
!2836 = metadata !{i32 786443, metadata !2823, i32 168, i32 10, metadata !870, i32 22} ; [ DW_TAG_lexical_block ]
!2837 = metadata !{i32 168, i32 56, metadata !2838, null}
!2838 = metadata !{i32 786443, metadata !2836, i32 168, i32 55, metadata !870, i32 23} ; [ DW_TAG_lexical_block ]
!2839 = metadata !{i32 169, i32 1, metadata !2838, null}
!2840 = metadata !{i32 170, i32 2, metadata !2838, null}
!2841 = metadata !{i32 171, i32 2, metadata !2838, null}
!2842 = metadata !{i32 168, i32 50, metadata !2836, null}
!2843 = metadata !{i32 786688, metadata !2836, metadata !"i", metadata !870, i32 168, metadata !886, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2844 = metadata !{i32 174, i32 2, metadata !2823, null}
!2845 = metadata !{i32 180, i32 3, metadata !2846, null}
!2846 = metadata !{i32 786443, metadata !2847, i32 176, i32 52, metadata !870, i32 25} ; [ DW_TAG_lexical_block ]
!2847 = metadata !{i32 786443, metadata !2823, i32 176, i32 12, metadata !870, i32 24} ; [ DW_TAG_lexical_block ]
!2848 = metadata !{i32 176, i32 37, metadata !2847, null}
!2849 = metadata !{i32 187, i32 27, metadata !2850, null}
!2850 = metadata !{i32 786443, metadata !2823, i32 187, i32 2, metadata !870, i32 27} ; [ DW_TAG_lexical_block ]
!2851 = metadata !{i32 176, i32 53, metadata !2846, null}
!2852 = metadata !{i32 178, i32 3, metadata !2846, null}
!2853 = metadata !{i32 179, i32 3, metadata !2846, null}
!2854 = metadata !{i32 181, i32 4, metadata !2855, null}
!2855 = metadata !{i32 786443, metadata !2846, i32 180, i32 22, metadata !870, i32 26} ; [ DW_TAG_lexical_block ]
!2856 = metadata !{i32 182, i32 3, metadata !2855, null}
!2857 = metadata !{i32 183, i32 3, metadata !2846, null}
!2858 = metadata !{i32 184, i32 2, metadata !2846, null}
!2859 = metadata !{i32 176, i32 47, metadata !2847, null}
!2860 = metadata !{i32 786688, metadata !2847, metadata !"i", metadata !870, i32 176, metadata !886, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2861 = metadata !{i32 187, i32 48, metadata !2862, null}
!2862 = metadata !{i32 786443, metadata !2850, i32 187, i32 47, metadata !870, i32 28} ; [ DW_TAG_lexical_block ]
!2863 = metadata !{i32 188, i32 1, metadata !2862, null}
!2864 = metadata !{i32 189, i32 2, metadata !2862, null}
!2865 = metadata !{i32 190, i32 2, metadata !2862, null}
!2866 = metadata !{i32 187, i32 42, metadata !2850, null}
!2867 = metadata !{i32 786688, metadata !2850, metadata !"i", metadata !870, i32 187, metadata !886, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2868 = metadata !{i32 191, i32 1, metadata !2823, null}
