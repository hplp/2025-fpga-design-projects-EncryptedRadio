...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { plaintext_TDATA { I 8 vector } plaintext_TVALID { I 1 bit } plaintext_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { ciphertext_TDATA { O 8 vector } ciphertext_TVALID { O 1 bit } ciphertext_TREADY { I 1 bit } } \
} "
} else {
