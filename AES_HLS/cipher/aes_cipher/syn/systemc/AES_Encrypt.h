...
struct AES_Encrypt : public sc_module {
    ...
    sc_in< sc_lv<8> > plaintext_TDATA;
    sc_in< sc_logic > plaintext_TVALID;
    sc_out< sc_logic > plaintext_TREADY;
    sc_in< sc_lv<8> > expandedKey_TDATA;
    sc_in< sc_logic > expandedKey_TVALID;
    sc_out< sc_logic > expandedKey_TREADY;
    sc_in< sc_lv<16> > Nr;
    sc_out< sc_lv<8> > ciphertext_TDATA;
    sc_out< sc_logic > ciphertext_TVALID;
    sc_in< sc_logic > ciphertext_TREADY;
    ...
    sc_signal< sc_lv<8> > plaintext_0_data_out;
    sc_signal< sc_logic > plaintext_0_vld_in;
    sc_signal< sc_logic > plaintext_0_vld_out;
    sc_signal< sc_logic > plaintext_0_ack_in;
    sc_signal< sc_logic > plaintext_0_ack_out;
    sc_signal< sc_lv<8> > plaintext_0_payload_A;
    sc_signal< sc_lv<8> > plaintext_0_payload_B;
    sc_signal< sc_logic > plaintext_0_sel_rd;
    sc_signal< sc_logic > plaintext_0_sel_wr;
    sc_signal< sc_logic > plaintext_0_sel;
    sc_signal< sc_logic > plaintext_0_load_A;
    sc_signal< sc_logic > plaintext_0_load_B;
    sc_signal< sc_lv<2> > plaintext_0_state;
    sc_signal< sc_logic > plaintext_0_state_cmp_full;
    ...
    sc_signal< sc_lv<8> > ciphertext_1_data_out;
    sc_signal< sc_logic > ciphertext_1_vld_in;
    sc_signal< sc_logic > ciphertext_1_vld_out;
    sc_signal< sc_logic > ciphertext_1_ack_in;
    sc_signal< sc_logic > ciphertext_1_ack_out;
    sc_signal< sc_lv<8> > ciphertext_1_payload_A;
    sc_signal< sc_lv<8> > ciphertext_1_payload_B;
    sc_signal< sc_logic > ciphertext_1_sel_rd;
    sc_signal< sc_logic > ciphertext_1_sel_wr;
    sc_signal< sc_logic > ciphertext_1_sel;
    sc_signal< sc_logic > ciphertext_1_load_A;
    sc_signal< sc_logic > ciphertext_1_load_B;
    sc_signal< sc_lv<2> > ciphertext_1_state;
    sc_signal< sc_logic > ciphertext_1_state_cmp_full;
    ...
    sc_signal< sc_logic > grp_MixColumns_fu_315_ap_start;
    sc_signal< sc_logic > grp_MixColumns_fu_315_ap_done;
    sc_signal< sc_logic > grp_MixColumns_fu_315_ap_idle;
    sc_signal< sc_logic > grp_MixColumns_fu_315_ap_ready;
    sc_signal< sc_lv<4> > grp_MixColumns_fu_315_state_address0;
    sc_signal< sc_logic > grp_MixColumns_fu_315_state_ce0;
    sc_signal< sc_logic > grp_MixColumns_fu_315_state_we0;
    sc_signal< sc_lv<8> > grp_MixColumns_fu_315_state_d0;
    sc_signal< sc_lv<4> > grp_MixColumns_fu_315_state_address1;
    sc_signal< sc_logic > grp_MixColumns_fu_315_state_ce1;
    sc_signal< sc_logic > grp_SubBytes_fu_322_ap_start;
    sc_signal< sc_logic > grp_SubBytes_fu_322_ap_done;
    sc_signal< sc_logic > grp_SubBytes_fu_322_ap_idle;
    sc_signal< sc_logic > grp_SubBytes_fu_322_ap_ready;
    sc_signal< sc_lv<4> > grp_SubBytes_fu_322_state_address0;
    sc_signal< sc_logic > grp_SubBytes_fu_322_state_ce0;
    sc_signal< sc_logic > grp_SubBytes_fu_322_state_we0;
    sc_signal< sc_lv<8> > grp_SubBytes_fu_322_state_d0;
    sc_signal< sc_lv<4> > grp_SubBytes_fu_322_state_address1;
    sc_signal< sc_logic > grp_SubBytes_fu_322_state_ce1;
    sc_signal< sc_logic > grp_SubBytes_fu_322_state_we1;
    sc_signal< sc_lv<8> > grp_SubBytes_fu_322_state_d1;
    sc_signal< sc_logic > grp_ShiftRows_fu_329_ap_start;
    sc_signal< sc_logic > grp_ShiftRows_fu_329_ap_done;
    sc_signal< sc_logic > grp_ShiftRows_fu_329_ap_idle;
    sc_signal< sc_logic > grp_ShiftRows_fu_329_ap_ready;
    sc_signal< sc_lv<4> > grp_ShiftRows_fu_329_state_address0;
    sc_signal< sc_logic > grp_ShiftRows_fu_329_state_ce0;
    sc_signal< sc_logic > grp_ShiftRows_fu_329_state_we0;
    sc_signal< sc_lv<8> > grp_ShiftRows_fu_329_state_d0;
    sc_signal< sc_lv<4> > grp_ShiftRows_fu_329_state_address1;
    sc_signal< sc_logic > grp_ShiftRows_fu_329_state_ce1;
    ...
    sc_signal< sc_logic > ap_reg_grp_MixColumns_fu_315_ap_start;
    sc_signal< sc_logic > ap_CS_fsm_state10;
    sc_signal< sc_logic > ap_CS_fsm_state11;
    sc_signal< sc_logic > ap_reg_grp_SubBytes_fu_322_ap_start;
    sc_signal< sc_logic > ap_CS_fsm_state7;
    sc_signal< sc_logic > ap_reg_grp_ShiftRows_fu_329_ap_start;
    ...
    void thread_ciphertext_1_ack_in();
    void thread_ciphertext_1_ack_out();
    void thread_ciphertext_1_data_out();
    void thread_ciphertext_1_load_A();
    void thread_ciphertext_1_load_B();
    void thread_ciphertext_1_sel();
    void thread_ciphertext_1_state_cmp_full();
    void thread_ciphertext_1_vld_in();
    void thread_ciphertext_1_vld_out();
    void thread_ciphertext_TDATA();
    void thread_ciphertext_TDATA_blk_n();
    void thread_ciphertext_TVALID();
    ...
    void thread_grp_MixColumns_fu_315_ap_start();
    void thread_grp_ShiftRows_fu_329_ap_start();
    void thread_grp_SubBytes_fu_322_ap_start();
    void thread_i_3_fu_345_p2();
    void thread_i_4_fu_370_p2();
    void thread_plaintext_0_ack_in();
    void thread_plaintext_0_ack_out();
    void thread_plaintext_0_data_out();
    void thread_plaintext_0_load_A();
    void thread_plaintext_0_load_B();
    void thread_plaintext_0_sel();
    void thread_plaintext_0_state_cmp_full();
    void thread_plaintext_0_vld_in();
    void thread_plaintext_0_vld_out();
    void thread_plaintext_TDATA_blk_n();
    void thread_plaintext_TREADY();
