...
(* CORE_GENERATION_INFO="AES_Encrypt,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.669000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=530,HLS_SYN_LUT=3201}" *)
...
wire    grp_MixColumns_fu_315_ap_start;
wire    grp_MixColumns_fu_315_ap_done;
wire    grp_MixColumns_fu_315_ap_idle;
wire    grp_MixColumns_fu_315_ap_ready;
wire   [3:0] grp_MixColumns_fu_315_state_address0;
wire    grp_MixColumns_fu_315_state_ce0;
wire    grp_MixColumns_fu_315_state_we0;
wire   [7:0] grp_MixColumns_fu_315_state_d0;
wire   [3:0] grp_MixColumns_fu_315_state_address1;
wire    grp_MixColumns_fu_315_state_ce1;
wire    grp_SubBytes_fu_322_ap_start;
wire    grp_SubBytes_fu_322_ap_done;
wire    grp_SubBytes_fu_322_ap_idle;
wire    grp_SubBytes_fu_322_ap_ready;
wire   [3:0] grp_SubBytes_fu_322_state_address0;
wire    grp_SubBytes_fu_322_state_ce0;
wire    grp_SubBytes_fu_322_state_we0;
wire   [7:0] grp_SubBytes_fu_322_state_d0;
wire   [3:0] grp_SubBytes_fu_322_state_address1;
wire    grp_SubBytes_fu_322_state_ce1;
wire    grp_SubBytes_fu_322_state_we1;
wire   [7:0] grp_SubBytes_fu_322_state_d1;
wire    grp_ShiftRows_fu_329_ap_start;
wire    grp_ShiftRows_fu_329_ap_done;
wire    grp_ShiftRows_fu_329_ap_idle;
wire    grp_ShiftRows_fu_329_ap_ready;
wire   [3:0] grp_ShiftRows_fu_329_state_address0;
wire    grp_ShiftRows_fu_329_state_ce0;
wire    grp_ShiftRows_fu_329_state_we0;
wire   [7:0] grp_ShiftRows_fu_329_state_d0;
wire   [3:0] grp_ShiftRows_fu_329_state_address1;
wire    grp_ShiftRows_fu_329_state_ce1;
...
reg    ap_reg_grp_MixColumns_fu_315_ap_start;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state11;
reg    ap_reg_grp_SubBytes_fu_322_ap_start;
wire    ap_CS_fsm_state7;
reg    ap_reg_grp_ShiftRows_fu_329_ap_start;
...
#0 ap_reg_grp_MixColumns_fu_315_ap_start = 1'b0;
#0 ap_reg_grp_SubBytes_fu_322_ap_start = 1'b0;
#0 ap_reg_grp_ShiftRows_fu_329_ap_start = 1'b0;
end
...
MixColumns grp_MixColumns_fu_315(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
ShiftRows grp_ShiftRows_fu_329(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_grp_MixColumns_fu_315_ap_start <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state10)) begin
            ap_reg_grp_MixColumns_fu_315_ap_start <= 1'b1;
        end else if ((grp_MixColumns_fu_315_ap_ready == 1'b1)) begin
            ap_reg_grp_MixColumns_fu_315_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_grp_ShiftRows_fu_329_ap_start <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state8)) begin
            ap_reg_grp_ShiftRows_fu_329_ap_start <= 1'b1;
        end else if ((grp_ShiftRows_fu_329_ap_ready == 1'b1)) begin
            ap_reg_grp_ShiftRows_fu_329_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_grp_SubBytes_fu_322_ap_start <= 1'b0;
    end else begin
        if (((exitcond_fu_365_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
            ap_reg_grp_SubBytes_fu_322_ap_start <= 1'b1;
        end else if ((grp_SubBytes_fu_322_ap_ready == 1'b1)) begin
            ap_reg_grp_SubBytes_fu_322_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((ciphertext_1_state == 2'd2) & (ciphertext_1_vld_in == 1'b0)) | ((ciphertext_1_state == 2'd3) & (ciphertext_1_vld_in == 1'b0) & (ciphertext_1_ack_out == 1'b1)))) begin
            ciphertext_1_state <= 2'd2;
        end else if ((((ciphertext_1_state == 2'd1) & (ciphertext_1_ack_out == 1'b0)) | ((ciphertext_1_state == 2'd3) & (ciphertext_1_ack_out == 1'b0) & (ciphertext_1_vld_in == 1'b1)))) begin
            ciphertext_1_state <= 2'd1;
        end else if (((~((ciphertext_1_vld_in == 1'b0) & (ciphertext_1_ack_out == 1'b1)) & ~((ciphertext_1_ack_out == 1'b0) & (ciphertext_1_vld_in == 1'b1)) & (ciphertext_1_state == 2'd3)) | ((ciphertext_1_state == 2'd1) & (ciphertext_1_ack_out == 1'b1)) | ((ciphertext_1_state == 2'd2) & (ciphertext_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((plaintext_0_state == 2'd2) & (plaintext_0_vld_in == 1'b0)) | ((plaintext_0_state == 2'd3) & (plaintext_0_vld_in == 1'b0) & (plaintext_0_ack_out == 1'b1)))) begin
            plaintext_0_state <= 2'd2;
        end else if ((((plaintext_0_state == 2'd1) & (plaintext_0_ack_out == 1'b0)) | ((plaintext_0_state == 2'd3) & (plaintext_0_ack_out == 1'b0) & (plaintext_0_vld_in == 1'b1)))) begin
            plaintext_0_state <= 2'd1;
        end else if (((~((plaintext_0_vld_in == 1'b0) & (plaintext_0_ack_out == 1'b1)) & ~((plaintext_0_ack_out == 1'b0) & (plaintext_0_vld_in == 1'b1)) & (plaintext_0_state == 2'd3)) | ((plaintext_0_state == 2'd1) & (plaintext_0_ack_out == 1'b1)) | ((plaintext_0_state == 2'd2) & (plaintext_0_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if ((grp_AddRoundKey_fu_295_ap_done == 1'b1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state30) & (ciphertext_1_ack_in == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state29) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state28) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state27) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state26) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state25) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state24) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state23) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state22) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state21) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state20) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state19) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state18) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state17) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state16) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state15) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state14) & (ciphertext_1_ack_in == 1'b1)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state28)) begin
        ...
        state_address0 = grp_SubBytes_fu_322_state_address0;
    end else if (((tmp_19_reg_413 == 1'd0) & (1'b1 == ap_CS_fsm_state11))) begin
        state_address0 = grp_MixColumns_fu_315_state_address0;
...
always @ (*) begin
    if ((((exitcond_fu_365_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state6)) | ((1'b1 == ap_CS_fsm_state28) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state27) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state26) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state25) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state24) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state23) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state22) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state21) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state20) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state19) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state18) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state17) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state16) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state15) & (ciphertext_1_ack_in == 1'b1)) | ((1'b1 == ap_CS_fsm_state14) & (ciphertext_1_ack_in == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        state_ce0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        state_ce0 = grp_ShiftRows_fu_329_state_ce0;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state7 : begin
            if (((grp_SubBytes_fu_322_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state7))) begin
        ...
        ap_ST_fsm_state9 : begin
            if (((tmp_19_reg_413 == 1'd1) & (grp_ShiftRows_fu_329_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
                ap_NS_fsm = ap_ST_fsm_state11;
            end else if (((tmp_19_reg_413 == 1'd0) & (grp_ShiftRows_fu_329_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        ...
        ap_ST_fsm_state13 : begin
            if (((grp_AddRoundKey_fu_295_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state13))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state13;
            end
        ...
        ap_ST_fsm_state14 : begin
            if (((1'b1 == ap_CS_fsm_state14) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state15 : begin
            if (((1'b1 == ap_CS_fsm_state15) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state16 : begin
            if (((1'b1 == ap_CS_fsm_state16) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state17 : begin
            if (((1'b1 == ap_CS_fsm_state17) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state18 : begin
            if (((1'b1 == ap_CS_fsm_state18) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state19 : begin
            if (((1'b1 == ap_CS_fsm_state19) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state20 : begin
            if (((1'b1 == ap_CS_fsm_state20) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state21 : begin
            if (((1'b1 == ap_CS_fsm_state21) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state22 : begin
            if (((1'b1 == ap_CS_fsm_state22) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state23 : begin
            if (((1'b1 == ap_CS_fsm_state23) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state24 : begin
            if (((1'b1 == ap_CS_fsm_state24) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state25 : begin
            if (((1'b1 == ap_CS_fsm_state25) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state26 : begin
            if (((1'b1 == ap_CS_fsm_state26) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state27 : begin
            if (((1'b1 == ap_CS_fsm_state27) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state28 : begin
            if (((1'b1 == ap_CS_fsm_state28) & (ciphertext_1_ack_in == 1'b1))) begin
        ...
        ap_ST_fsm_state29 : begin
            if (((1'b1 == ap_CS_fsm_state29) & (ciphertext_1_ack_in == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((tmp_reg_391 == 1'd0) & (plaintext_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((tmp_reg_391 == 1'd0) & (plaintext_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_state11_on_subcall_done = ((tmp_19_reg_413 == 1'd0) & (grp_MixColumns_fu_315_ap_done == 1'b0));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((tmp_reg_391 == 1'd0) & (plaintext_0_vld_out == 1'b0));
end
...
assign grp_MixColumns_fu_315_ap_start = ap_reg_grp_MixColumns_fu_315_ap_start;

assign grp_ShiftRows_fu_329_ap_start = ap_reg_grp_ShiftRows_fu_329_ap_start;

assign grp_SubBytes_fu_322_ap_start = ap_reg_grp_SubBytes_fu_322_ap_start;
