set moduleName AES_Full_Pipeline_L_copy1
set isTopModule 0
...
set C_modelName {AES_Full_Pipeline_L_copy1}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_in int 8 regular {array 16 { 1 } 1 1 }  }
	{ state_1 int 8 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_in", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "state_1", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ data_in_q0 sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_in_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_in", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	data_in { ap_memory {  { data_in_address0 mem_address 1 4 }  { data_in_ce0 mem_ce 1 1 }  { data_in_q0 in_data 0 8 } } }
	state_1 { ap_memory {  { state_1_address0 mem_address 1 4 }  { state_1_ce0 mem_ce 1 1 }  { state_1_we0 mem_we 1 1 }  { state_1_d0 mem_din 1 8 } } }
}
