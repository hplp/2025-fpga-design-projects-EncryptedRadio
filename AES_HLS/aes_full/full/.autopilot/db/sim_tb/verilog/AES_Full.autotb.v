...
`define AUTOTB_DUT      AES_Full
`define AUTOTB_DUT_INST AESL_inst_AES_Full
`define AUTOTB_TOP      apatb_AES_Full_top
`define AUTOTB_LAT_RESULT_FILE "AES_Full.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "AES_Full.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_AES_Full_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_mode_cipher 1
`define AESL_DEPTH_mode_inverse_cipher 1
...
`define AUTOTB_TVIN_mode_cipher  "./c.AES_Full.autotvin_mode_cipher.dat"
`define AUTOTB_TVIN_mode_inverse_cipher  "./c.AES_Full.autotvin_mode_inverse_cipher.dat"
`define AUTOTB_TVIN_data_in  "./c.AES_Full.autotvin_data_in.dat"
`define AUTOTB_TVIN_expandedKey  "./c.AES_Full.autotvin_expandedKey.dat"
`define AUTOTB_TVIN_Nr  "./c.AES_Full.autotvin_Nr.dat"
`define AUTOTB_TVIN_mode_cipher_out_wrapc  "./rtl.AES_Full.autotvin_mode_cipher.dat"
`define AUTOTB_TVIN_mode_inverse_cipher_out_wrapc  "./rtl.AES_Full.autotvin_mode_inverse_cipher.dat"
`define AUTOTB_TVIN_data_in_out_wrapc  "./rtl.AES_Full.autotvin_data_in.dat"
`define AUTOTB_TVIN_expandedKey_out_wrapc  "./rtl.AES_Full.autotvin_expandedKey.dat"
`define AUTOTB_TVIN_Nr_out_wrapc  "./rtl.AES_Full.autotvin_Nr.dat"
`define AUTOTB_TVOUT_data_out  "./c.AES_Full.autotvout_data_out.dat"
`define AUTOTB_TVOUT_data_out_out_wrapc  "./impl_rtl.AES_Full.autotvout_data_out.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_mode_cipher = 1;
parameter LENGTH_mode_inverse_cipher = 1;
...
reg end_mode_cipher;
reg [31:0] size_mode_cipher;
reg [31:0] size_mode_cipher_backup;
reg end_mode_inverse_cipher;
reg [31:0] size_mode_inverse_cipher;
reg [31:0] size_mode_inverse_cipher_backup;
reg end_data_in;
...
initial begin : dump_tvout_runtime_sign_data_out
    ...
    fp = $fopen(`AUTOTB_TVOUT_data_out_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    fp = $fopen(`AUTOTB_TVOUT_data_out_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_data_out_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
