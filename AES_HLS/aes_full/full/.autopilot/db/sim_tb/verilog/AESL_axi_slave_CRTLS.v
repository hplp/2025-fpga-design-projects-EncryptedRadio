...
//------------------------Parameter----------------------
`define TV_IN_mode_cipher "./c.AES_Full.autotvin_mode_cipher.dat"
`define TV_IN_mode_inverse_cipher "./c.AES_Full.autotvin_mode_inverse_cipher.dat"
`define TV_IN_data_in "./c.AES_Full.autotvin_data_in.dat"
`define TV_IN_expandedKey "./c.AES_Full.autotvin_expandedKey.dat"
`define TV_IN_Nr "./c.AES_Full.autotvin_Nr.dat"
`define TV_OUT_data_out "./rtl.AES_Full.autotvout_data_out.dat"
