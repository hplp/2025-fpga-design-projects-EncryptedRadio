...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AES_Full.autotvin.dat"
	set constFileTvOut       "AES_Full.autotvout.dat"
	set constFileHdlTvIn     "AES_Full.autohdltvin.dat"
	set constFileHdlTvOut    "AES_Full.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
