...
if {[file isfile AES_Full.autotvin.dat]} {
	file delete -force AES_Full.autotvin.dat
}

if {[file isfile AES_Full.autotvout.dat]} {
	file delete -force AES_Full.autotvout.dat
}
