...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AES_Full.autotvin_mode_cipher.dat"
         "c.AES_Full.autotvin_mode_inverse_cipher.dat"
         "c.AES_Full.autotvin_data_in.dat"
         "c.AES_Full.autotvin_expandedKey.dat"
         "c.AES_Full.autotvin_Nr.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AES_Full.autotvout_data_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
