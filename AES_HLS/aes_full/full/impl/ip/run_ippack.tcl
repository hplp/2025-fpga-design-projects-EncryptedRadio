...
set IPName      "AES_Full"
set Version     "1.0"
set DisplayName "Aes_full"
set Revision    "2114044003"
...
set xo_kernel_name "AES_Full"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/kuh4bd/Documents/FPGALab/Project_UART/AES_HLS/aes_full/full"
set debug_dir "C:/Users/kuh4bd/Documents/FPGALab/Project_UART/AES_HLS/aes_full/full/.debug"
set xo_hls_files_dir ""
set hdl_module_list {AES_Full_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_CRTLS {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_EN RW 0 {Enable Channel 2 (ap_local_deadlock) Interrupt.  0 = Disabled, 1 = Enabled.}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_ST RTOW 0 {Channel 2 (ap_local_deadlock) Interrupt Status. 0 = No Channel 2 input interrupt, 1 = Channel 2 input interrup}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x10 mode_cipher W 0x0 "Data signal of mode_cipher" {{0 1 mode_cipher W 0 "Bit 0 to 0 of mode_cipher"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 mode_inverse_cipher W 0x0 "Data signal of mode_inverse_cipher" {{0 1 mode_inverse_cipher W 0 "Bit 0 to 0 of mode_inverse_cipher"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 Nr W 0x0 "Data signal of Nr" {{0 16 Nr W 0 "Bit 15 to 0 of Nr"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "data_in {base_address 32 range 16} data_out {base_address 64 range 16} expandedKey {base_address 256 range 256}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
