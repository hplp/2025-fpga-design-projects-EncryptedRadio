...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module InvMixColumns_mul11_rom (
...
initial begin
    $readmemh("./InvMixColumns_mul11_rom.dat", ram0);
    $readmemh("./InvMixColumns_mul11_rom.dat", ram1);
end
...
InvMixColumns_mul11_rom InvMixColumns_mul11_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
