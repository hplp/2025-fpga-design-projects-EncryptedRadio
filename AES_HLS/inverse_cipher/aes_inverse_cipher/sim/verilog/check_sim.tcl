...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AES_Decrypt.autotvin_ciphertext.dat"
         "c.AES_Decrypt.autotvin_expandedKey.dat"
         "c.AES_Decrypt.autotvin_Nr.dat"
         "c.AES_Decrypt.autotvin_plaintext.dat"
         "c.AES_Decrypt.autotvout_plaintext.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AES_Decrypt.autotvout_plaintext.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
