...
set ::env(PATH) "$::env(PATH);C:/Dev/Xilinx/Vivado/2017.4/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Dev/Xilinx/Vivado/2017.4/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Dev/Xilinx/Vivado/2017.4/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);C:/Dev/Xilinx/Vivado/2017.4/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Dev/Xilinx/Vivado/2017.4/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AES_Decrypt.autotvin.dat"
	set constFileTvOut       "AES_Decrypt.autotvout.dat"
	set constFileHdlTvIn     "AES_Decrypt.autohdltvin.dat"
	set constFileHdlTvOut    "AES_Decrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
