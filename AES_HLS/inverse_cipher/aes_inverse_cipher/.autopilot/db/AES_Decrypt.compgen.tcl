...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { ciphertext_TDATA { I 8 vector } ciphertext_TVALID { I 1 bit } ciphertext_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { expandedKey_TDATA { I 8 vector } expandedKey_TVALID { I 1 bit } expandedKey_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { plaintext_TDATA { O 8 vector } plaintext_TVALID { O 1 bit } plaintext_TREADY { I 1 bit } } \
} "
} else {
