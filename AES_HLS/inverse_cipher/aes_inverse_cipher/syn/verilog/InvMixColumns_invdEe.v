...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module InvMixColumns_invdEe_rom (
...
initial begin
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram0);
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram1);
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram2);
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram3);
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram4);
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram5);
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram6);
    $readmemh("./InvMixColumns_invdEe_rom.dat", ram7);
end
...
InvMixColumns_invdEe_rom InvMixColumns_invdEe_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
